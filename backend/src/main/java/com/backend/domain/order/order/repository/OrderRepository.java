...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("SELECT o FROM Order o WHERE o.email = :email AND o.shippingDate = :shippingDate AND o.address = :address AND o.zipcode = :zipcode AND o.status <> :excludedStatus")
